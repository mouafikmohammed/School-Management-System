    ...
    {   
        if($admin_name !== $row_db['username']){
            if($admin_password == $admin_c_password){
                $sql4 ="INSERT INTO `admin`(`username`, `email`, `password`, `c_password`, `image`, `a_role`) VALUES 
                ('$admin_name','$admin_email','$admin_password','$admin_c_password','$img','$admin_role')";
